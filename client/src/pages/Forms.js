    ...
    <>
      ...
      <div className="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <Label>
          ...
          <div className="relative text-gray-500 focus-within:text-blue-500 dark:focus-within:text-purple-400">
            <input
        ...
        <Label>
          ...
          <div className="relative">
            <input
              ...
              placeholder="Jane Doe"
            />
            <button className="absolute inset-y-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-500 border border-transparent rounded-l-md active:bg-blue-500 hover:bg-blue-700 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
              Click
            </button>
          </div>
        </Label>
        ...
        <Label className="mt-4">
          ...
          <div className="relative text-gray-500 focus-within:text-blue-500">
            <input
              ...
              placeholder="Jane Doe"
            />
            <button className="absolute inset-y-0 right-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-500 border border-transparent rounded-r-md active:bg-blue-500 hover:bg-blue-700 focus:outline-none focus:shadow-outline-purple">
              Click
            </button>
          </div>
        </Label>
