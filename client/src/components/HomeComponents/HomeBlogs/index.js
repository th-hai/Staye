					...
					<div className="grid grid-cols-12 col-span-12 gap-7">
						<div className="flex flex-col items-start col-span-12 overflow-hidden shadow-sm rounded-xl md:col-span-6 lg:col-span-4">
							...
							<div className="relative flex flex-col items-start px-6 bg-white border border-t-0 border-gray-200 py-7 rounded-b-2xl">
								...
								<h2 className="text-base font-bold sm:text-lg md:text-xl"><a href="#_">10 things to experience enough to make a trip to Hong Kong worth every penny
</a></h2>
						...
						<div className="flex flex-col items-start col-span-12 overflow-hidden shadow-sm rounded-xl md:col-span-6 lg:col-span-4">
							...
							<div className="relative flex flex-col items-start px-6 bg-white border border-t-0 border-gray-200 py-7 rounded-b-2xl">
								...
								<h2 className="text-base font-bold sm:text-lg md:text-xl"><a href="#_">Pocket 4 tips when traveling in the rainy season</a></h2>
						...
						<div className="flex flex-col items-start col-span-12 overflow-hidden shadow-sm rounded-xl md:col-span-6 lg:col-span-4">
							...
							<div className="relative flex flex-col items-start px-6 bg-white border border-t-0 border-gray-200 py-7 rounded-b-2xl">
								...
								<h2 className="text-base font-bold sm:text-lg md:text-xl"><a href="#_">4 attractive, affordable crab noodle shops in Binh Thanh district</a></h2>
